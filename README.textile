...
*Please note that these tests all require some basic
 "Ruby":http://ruby-lang.org knowledge. If you don't know ruby, "take
 a few minutes to learn the
 basics":http://www.ruby-lang.org/en/documentation/quickstart/.  You
 will need to have Ruby, "rubygems":http://rubygems.org,
 "RSpec":http://rspec.info , "Factory
 Girl":http://github.com/thoughtbot/factory_girl and "redgreen":http://github.com/mynyml/redgreen installed.*
